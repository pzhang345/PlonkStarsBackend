...
def upgrade():
    ...
    with op.batch_alter_table('guesses', schema=None) as batch_op:
        batch_op.drop_constraint(None, type_='foreignkey', columns=['user_id'])
        batch_op.drop_constraint(None, type_='foreignkey', columns=['round_id'])
    ...
    with op.batch_alter_table('mapbounds', schema=None) as batch_op:
        batch_op.drop_constraint(None, type_='foreignkey', columns=['map_id'])
        batch_op.drop_constraint(None, type_='foreignkey', columns=['bound_id'])
    ...
    with op.batch_alter_table('maps', schema=None) as batch_op:
        batch_op.drop_constraint(None, type_='foreignkey',columns=['creator_id'])  
    ...
    with op.batch_alter_table('players', schema=None) as batch_op:
        batch_op.drop_constraint(None, type_='foreignkey', columns=['user_id'])
        batch_op.drop_constraint(None, type_='foreignkey', columns=['session_id'])
    ...
    with op.batch_alter_table('rounds', schema=None) as batch_op:
        batch_op.drop_constraint(None, type_='foreignkey', columns=['session_id'])
        batch_op.drop_constraint(None, type_='foreignkey', columns=['location_id'])
    ...
    with op.batch_alter_table('sessions', schema=None) as batch_op:
        batch_op.drop_constraint(None, type_='foreignkey', columns=['map_id'])
        batch_op.drop_constraint(None, type_='foreignkey', columns=['host_id'])
